...
namespace sincDelivery.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> DodajVozaca(KorisnikBDO korisnikBDO)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    UserName = korisnikBDO.UserName+"@sync.com",
                    Email = korisnikBDO.UserName+"@sync.com",
                    Ime = korisnikBDO.Ime,
                    Prezime = korisnikBDO.Prezime,
                    Spol = korisnikBDO.Spol,
                    KorisnikTipID = 2,
                    Aktivan=true,
                    Telefon=korisnikBDO.Telefon,
            ...
            {
               // ModelState.AddModelError("Dogodila se greska prilikom unosa novog zaposlenika zbog unosa parametar",);
                return View(korisnikBDO);
            }
        ...
        public async Task DodajNovogVozaca (KorisnikBDO korisnikBDO)
        {
            sincDeliveryEntities db = new sincDeliveryEntities();
